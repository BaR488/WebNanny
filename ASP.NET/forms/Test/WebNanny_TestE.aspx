...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="WebNanny_TestE.aspx.cs" Inherits="IIS.Product_31146.WebNanny_TestE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Test</h2>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrltestintLabel" runat="server" Text="Testint" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrltestint" Type="Numeric" runat="server">
</ac:AlphaNumericTextBox>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlteststringLabel" runat="server" Text="Teststring" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlteststring" runat="server">
</asp:TextBox>
